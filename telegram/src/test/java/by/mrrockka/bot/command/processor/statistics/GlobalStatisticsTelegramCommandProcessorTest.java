...
class GlobalStatisticsTelegramCommandProcessorTest {
  @Mock
  private StatisticsTelegramFacadeService statisticsTelegramFacadeService;
  @InjectMocks
  private GlobalStatisticsTelegramCommandProcessor globalStatisticsTelegramCommandProcessor;
  ...
  void givenMessageMetadata_whenProcessorExecuted_thenShouldReturnBotMessage() {
    ...
    assertThat(globalStatisticsTelegramCommandProcessor.process(metadata)).isEqualTo(expected);
  }
}