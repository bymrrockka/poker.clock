...
class MyStatisticsTelegramCommandProcessorTest {
  @Mock
  private StatisticsTelegramFacadeService statisticsTelegramFacadeService;
  @InjectMocks
  private MyStatisticsTelegramCommandProcessor myStatisticsTelegramCommandProcessor;
  ...
  void givenMessageMetadata_whenProcessorExecuted_thenShouldReturnBotMessage() {
    ...
    assertThat(myStatisticsTelegramCommandProcessor.process(metadata)).isEqualTo(expected);
  }
}